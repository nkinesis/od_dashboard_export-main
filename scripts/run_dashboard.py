...
@app.route("/od/building_emission_scale")
...
@app.route("/od/zone_building_fabric")
...
@app.route("/od/building_footprint")
...
@app.route("/od/zone_incoming_flow")
...
@app.route("/od/zone_incoming_flows_all")
